...
--
-- Host: localhost
-- Generation Time: Jun 01, 2021 at 12:25 AM
...
(2, 'en_US', 'create', '2021-05-15 08:13:17', 13, 'App\\Entity\\Cms\\Page', 1, 'a:1:{s:4:\"text\";s:16:\"<p>TEST PAGE</p>\";}', NULL);
...
--
-- Table structure for table `VSUS_MailchimpAudiences`
--

CREATE TABLE `VSUS_MailchimpAudiences` (
  `id` int NOT NULL,
  `audience_id` varchar(16) NOT NULL,
  `description` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Dumping data for table `VSUS_MailchimpAudiences`
--

INSERT INTO `VSUS_MailchimpAudiences` (`id`, `audience_id`, `description`) VALUES
(1, 'f462507092', 'Unique id for audience VankoSoft');

-- --------------------------------------------------------

--
-- Table structure for table `VSUS_NewsletterSubscriptions`
--

CREATE TABLE `VSUS_NewsletterSubscriptions` (
  `id` int NOT NULL,
  `user_id` int DEFAULT NULL,
  `user_email` varchar(64) NOT NULL,
  `mailchimp_audience_id` int NOT NULL,
  `date` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Dumping data for table `VSUS_NewsletterSubscriptions`
--

INSERT INTO `VSUS_NewsletterSubscriptions` (`id`, `user_id`, `user_email`, `mailchimp_audience_id`, `date`) VALUES
(1, NULL, 'ivanat@mailinator.com', 1, '2021-05-30 12:39:37'),
(2, NULL, 'sdfsfs@sdsfsd.com', 1, '2021-05-30 12:50:04'),
(3, NULL, 'ivanat@mailinator.com', 1, '2021-05-30 12:54:29'),
(4, NULL, 'ivanat@mailinator.com', 1, '2021-05-30 13:00:01'),
(5, NULL, 'ivanat@mailinator.com', 1, '2021-05-30 15:07:56'),
(6, NULL, 'ivanat@mailinator.com', 1, '2021-05-30 16:57:22'),
(7, NULL, 'z47oasbu@ch.MintEmail.com', 1, '2021-05-30 18:13:18');
...
--
-- Indexes for table `VSUS_MailchimpAudiences`
--
ALTER TABLE `VSUS_MailchimpAudiences`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `VSUS_NewsletterSubscriptions`
--
ALTER TABLE `VSUS_NewsletterSubscriptions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `mailchimpAudience_id` (`mailchimp_audience_id`);
...
--
-- AUTO_INCREMENT for table `VSUS_MailchimpAudiences`
--
ALTER TABLE `VSUS_MailchimpAudiences`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `VSUS_NewsletterSubscriptions`
--
ALTER TABLE `VSUS_NewsletterSubscriptions`
