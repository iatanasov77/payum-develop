...
--
-- Host: localhost
-- Generation Time: Mar 03, 2021 at 08:44 AM
...
CREATE TABLE `VSUM_Users` (
  ...
  `prefered_locale` varchar(16) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'en_US',
...
INSERT INTO `VSUM_Users` (`id`, `api_token`, `username`, `email`, `enabled`, `salt`, `password`, `last_login`, `confirmation_token`, `password_requested_at`, `roles`, `subscriptionId`, `user_info_id`, `prefered_locale`, `first_name`, `last_name`, `info_id`) VALUES
(1, NULL, 'admin', 'admin', 1, 'ZEAYhdMkJnNRZ0t5JO0Ol5AecbXAwj3ennB0CrmBIBY', '$argon2i$v=19$m=65536,t=4,p=1$MWFNejhXMzFwVFdpVElGMg$qq6lIt3kFlHxPq6plag34jEwsfMvglffqYH9UkKL26Q', '2020-04-18 13:20:04', NULL, NULL, 'a:1:{i:0;s:10:\"ROLE_ADMIN\";}', 3, 4, 'en_US', 'Admin', 'Admin', 4);
