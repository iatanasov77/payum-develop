...
--
-- Host: localhost
-- Generation Time: Nov 11, 2020 at 04:45 PM
...
--
-- Table structure for table `APP_SiteSettings`
--
...
--
-- Table structure for table `APP_Taxonomy`
--
...
--
-- Dumping data for table `APP_Taxonomy`
--
...
--
-- Table structure for table `APP_Taxons`
--
...
--
-- Dumping data for table `APP_Taxons`
--
...
--
-- Table structure for table `APP_TaxonTranslations`
--
...
--
-- Dumping data for table `APP_TaxonTranslations`
--
...
--
-- Table structure for table `IACMS_PageCategories_BACKUP`
--
...
--
-- Dumping data for table `IACMS_PageCategories_BACKUP`
--
...
CREATE TABLE `IAUM_Users` (
  `id` int NOT NULL,
  `prefered_locale` varchar(6) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'en',
...
INSERT INTO `IAUM_Users` (`id`, `prefered_locale`, `username`, `email`, `enabled`, `salt`, `password`, `first_name`, `last_name`, `last_login`, `confirmation_token`, `password_requested_at`, `roles`, `subscriptionId`, `info_id`) VALUES
(1, 'en', 'admin', 'admin', 1, 'ZEAYhdMkJnNRZ0t5JO0Ol5AecbXAwj3ennB0CrmBIBY', '$argon2i$v=19$m=65536,t=4,p=1$MWFNejhXMzFwVFdpVElGMg$qq6lIt3kFlHxPq6plag34jEwsfMvglffqYH9UkKL26Q', NULL, NULL, '2020-04-18 13:20:04', NULL, NULL, 'a:1:{i:0;s:10:\"ROLE_ADMIN\";}', 3, 4),
(2, 'en', 'admin2', 'admin2', 1, '.oHKGUigY1G7Z0zMWuYTGC4DZ2Mc9fQNZ2jBLvkTTn0', '$argon2i$v=19$m=65536,t=4,p=1$MWFNejhXMzFwVFdpVElGMg$qq6lIt3kFlHxPq6plag34jEwsfMvglffqYH9UkKL26Q', NULL, NULL, NULL, NULL, NULL, 'a:0:{}', NULL, NULL),
(3, 'en', 'admin', 'admin', 1, 'rID/Lqp8tiUKWL9s7pAPzal3y00yLvBzx0UC88V8.Zk', '$argon2i$v=19$m=65536,t=4,p=1$NkdQVUMuNXYzZGNxL2U1Nw$lMSM2JxwjZNuo53LCGeuEVh0izOxrwUGIb2D5h9a/64', NULL, NULL, NULL, NULL, NULL, 'a:0:{}', NULL, NULL);
...
INSERT INTO `IAUM_UsersInfo` (`id`, `apiToken`, `country`, `birthday`, `mobile`, `website`, `occupation`) VALUES
(4, NULL, 'BG', '1977-08-09 00:00:00', '449999999999', NULL, NULL);
