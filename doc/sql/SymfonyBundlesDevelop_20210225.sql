...
INSERT INTO `VSAPP_Settings` (`id`, `site_id`, `maintenanceMode`, `maintenance_page_id`, `theme`) VALUES
(1, 0, 1, 1, NULL),
(2, NULL, 1, 1, 'vankosoft/test-theme'),
(3, 1, 1, 1, NULL),
(4, NULL, 1, 1, 'vankosoft/test-theme');

-- --------------------------------------------------------

--
-- Table structure for table `VSAPP_SiteSettings`
--

CREATE TABLE `VSAPP_SiteSettings` (
  `id` int NOT NULL,
  `settings_id` int NOT NULL,
  `site_id` int NOT NULL COMMENT 'Taxon ID from taxonomy Sites'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(11, 'en_US', 'App\\Entity\\Taxonomy\\Taxonomy', NULL, 'name', '3', 'Page Categories en_US Translation'),
...
(17, 'en_US', 'App\\Entity\\Taxonomy\\Taxonomy', NULL, 'name', '5', 'TEST 999'),
(18, 'en_US', 'App\\Entity\\Taxonomy\\Taxonomy', NULL, 'description', '5', 'TEST 999'),
(19, 'en_US', 'App\\Entity\\Taxonomy\\Taxonomy', NULL, 'name', '6', 'TEST 1000'),
(20, 'en_US', 'App\\Entity\\Taxonomy\\Taxonomy', NULL, 'description', '6', 'TEST 1000');
...
INSERT INTO `VSCMS_PageCategories` (`id`, `page_id`, `taxon_id`) VALUES
(1, 2, 13),
(2, 8, 13),
(3, 3, 13);
...
--
-- Table structure for table `VSCMS_PageCategories_BACKUP`
--

CREATE TABLE `VSCMS_PageCategories_BACKUP` (
  `id` int NOT NULL,
...
--
-- Dumping data for table `VSCMS_PageCategories_BACKUP`
--

INSERT INTO `VSCMS_PageCategories_BACKUP` (`id`, `name`, `lft`, `lvl`, `rgt`, `root_id`, `parent_id`) VALUES
...
INSERT INTO `VSCMS_Pages` (`id`, `category_id`, `slug`, `title`, `text`, `published`) VALUES
...
CREATE TABLE `VSUM_Users` (
  ...
  `prefered_locale` varchar(16) NOT NULL DEFAULT 'en',
...
INSERT INTO `VSUM_Users` (`id`, `username`, `email`, `enabled`, `salt`, `password`, `last_login`, `confirmation_token`, `password_requested_at`, `roles`, `subscriptionId`, `user_info_id`, `prefered_locale`, `first_name`, `last_name`, `info_id`) VALUES
(1, 'admin', 'admin', 1, 'ZEAYhdMkJnNRZ0t5JO0Ol5AecbXAwj3ennB0CrmBIBY', '$argon2i$v=19$m=65536,t=4,p=1$MWFNejhXMzFwVFdpVElGMg$qq6lIt3kFlHxPq6plag34jEwsfMvglffqYH9UkKL26Q', '2020-04-18 13:20:04', NULL, NULL, 'a:1:{i:0;s:10:\"ROLE_ADMIN\";}', 3, 4, 'en', 'Admin', 'Admin', 4),
(2, 'admin2', 'admin2', 1, '.oHKGUigY1G7Z0zMWuYTGC4DZ2Mc9fQNZ2jBLvkTTn0', '$argon2i$v=19$m=65536,t=4,p=1$MWFNejhXMzFwVFdpVElGMg$qq6lIt3kFlHxPq6plag34jEwsfMvglffqYH9UkKL26Q', NULL, NULL, NULL, 'a:0:{}', NULL, NULL, 'en', 'NOT_EDITED_YET', 'NO_EDITED_YET', NULL),
(3, 'admin', 'admin', 1, 'rID/Lqp8tiUKWL9s7pAPzal3y00yLvBzx0UC88V8.Zk', '$argon2i$v=19$m=65536,t=4,p=1$NkdQVUMuNXYzZGNxL2U1Nw$lMSM2JxwjZNuo53LCGeuEVh0izOxrwUGIb2D5h9a/64', NULL, NULL, NULL, 'a:0:{}', NULL, NULL, 'en', 'NOT_EDITED_YET', 'NO_EDITED_YET', NULL);
...
INSERT INTO `VSUM_UsersInfo` (`id`, `apiToken`, `firstName`, `lastName`, `country`, `birthday`, `mobile`, `website`, `occupation`) VALUES
...
--
-- Indexes for table `VSAPP_SiteSettings`
--
ALTER TABLE `VSAPP_SiteSettings`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `VSCMS_PageCategories_BACKUP`
--
ALTER TABLE `VSCMS_PageCategories_BACKUP`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `VSAPP_SiteSettings`
--
ALTER TABLE `VSAPP_SiteSettings`
...
--
-- AUTO_INCREMENT for table `VSCMS_PageCategories_BACKUP`
--
ALTER TABLE `VSCMS_PageCategories_BACKUP`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
