...
--
-- Table structure for table `VSUM_UserGroups`
--

CREATE TABLE `VSUM_UserGroups` (
  `id` int NOT NULL,
...
--
-- Table structure for table `VSUM_Users_Groups`
--

CREATE TABLE `VSUM_Users_Groups` (
  `userId` int NOT NULL,
...
--
-- Indexes for table `VSUM_UserGroups`
--
ALTER TABLE `VSUM_UserGroups`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `VSUM_UserGroups`
--
ALTER TABLE `VSUM_UserGroups`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
